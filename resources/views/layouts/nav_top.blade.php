	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar">
			<ul class="nav navbar-nav">
				...
				@else
					<li><a href="{{ action('ContragentsController@index') }}"><i class="fa fa-fw fa-btn fa-building"></i> {{ trans('app.Contragents') }}</a></li>
					<li><a href="{{ action('ClientsController@index') }}"><i class="fa fa-fw fa-btn fa-building-o"></i> {{ trans('app.Clients') }}</a></li>
					@can('view-admin')
				...
				{{-- <li><a href="#">Link</a></li> --}}
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								{{-- <a href="{{ action('AuthController@logout') }}"><i class="fa fa-fw fa-btn fa-sign-out"></i> {{ trans('app.Logout') }}</a> --}}
								<a href="{{ url('/logout') }}"
